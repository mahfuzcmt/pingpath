              ...
              <motion.div variants={fadeInUp}>
                ...
                <div className="mt-10 space-y-6">
                  ...
                  <motion.a
                    ...
                    whileHover={{ x: 4 }}
                    className="flex items-start gap-4 rounded-xl border border-gray-100 bg-gray-50 p-5 transition-all hover:border-teal-100 hover:shadow-md"
                  >
                ...
                <div className="rounded-2xl bg-gray-50 p-8 shadow-sm">
                  ...
                  <form className="space-y-5">
                    <div className="grid gap-5 sm:grid-cols-2">
                      <div>
                        ...
                        <input
                          type="text"
                          required
                          className="h-12 w-full rounded-xl border border-gray-200 bg-white px-4 text-gray-900 placeholder-gray-400 outline-none transition focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20"
                          placeholder=""
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <select className="h-12 w-full rounded-xl border border-gray-200 bg-white px-4 text-gray-700 outline-none transition focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20">
                    ...
                    <div>
                      ...
                      <textarea
                        rows={4}
                        className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-gray-900 placeholder-gray-400 outline-none transition focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20"
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.99 }}
                      className="flex h-14 w-full items-center justify-center gap-2 rounded-xl bg-teal-600 text-[15px] font-bold text-white shadow-lg shadow-teal-600/30 transition-all hover:bg-teal-700 hover:shadow-xl"
                    >
                      {t("contact.submit")}
