        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 space-y-2">
              <a href="tel:+8801700000000" className="flex items-center gap-2 text-sm text-ink-400 hover:text-white transition-colors">
            ...
            <div className="mt-6 flex gap-4">
              ...
              <a href="https://wa.me/8801700000000" target="_blank" rel="noopener noreferrer" className="text-ink-400 hover:text-white transition-colors" aria-label="WhatsApp">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
